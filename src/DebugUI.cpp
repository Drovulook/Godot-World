...
void DebugUI::_ready() {
  ...
  Label *province_title = memnew(Label);
  province_title->set_text("Province: ");
  province_hbox->add_child(province_title);

  m_province_name_label = memnew(Label);
  m_province_name_label->set_text("None");
  province_hbox->add_child(m_province_name_label);
